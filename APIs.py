...
non_triggers['most_eq_inv_date'] = non_triggers['most_eq_inv_num'] = ['most', 'majority']
non_triggers['most_str_eq_inv'] = non_triggers['most_eq_inv_date']
non_triggers['most_greater_inv_date'] = non_triggers['most_greater_inv_num'] = non_triggers['most_eq_inv_date']
non_triggers['most_greater_eq_inv_date'] = non_triggers['most_greater_eq_inv_num'] = [
    non_triggers['filter_greater_eq'], non_triggers['most_eq_inv_date']]
non_triggers['most_less_inv_date'] = non_triggers['most_less_inv_num'] = [
    non_triggers["filter_less"], non_triggers['most_eq_inv_date']]
non_triggers['most_less_eq_inv_date'] = non_triggers['most_less_eq_inv_num'] = non_triggers['most_eq_inv_date']

non_triggers['all_str_eq_inv'] = non_triggers['all_str_eq']
non_triggers['all_greater_inv_date'] = non_triggers['all_greater_inv_num'] = non_triggers['all_greater']
non_triggers['all_greater_eq_inv_date'] = non_triggers['all_greater_eq_inv_num'] = non_triggers['all_greater_eq']
non_triggers['all_less_inv_date'] = non_triggers['all_less_inv_num'] = non_triggers['all_less']
non_triggers['all_less_eq_inv_date'] = non_triggers['all_less_eq_inv_num'] = non_triggers['all_less_eq']
non_triggers['all_eq_inv_date'] = non_triggers['all_eq_inv_num'] = non_triggers['all_eq']
